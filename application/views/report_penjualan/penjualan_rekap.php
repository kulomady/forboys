...
if($type=='EXCEL'):
	...
	header('Content-Disposition: attachment; filename=penjualan_rekap'.$tgl1."_".$tgl2.".xls");	
endif;
?>
...
<table width="1198" border="0" cellspacing="1">
  <tr>
    ...
    <td width="55" bgcolor="#3399FF"><div align="center"><strong>DP SO</strong></div></td>
    <td width="72" bgcolor="#3399FF"><div align="center"><strong>DP/Tunai</strong></div></td>
    <td width="92" bgcolor="#3399FF"><div align="center"><strong>Kredit</strong></div></td>
  </tr>
  <?php 
  $qr = "";
  $join = "";
  ...
  $sql = $this->db->query("select a.id,a.kdtrans,a.tgl,a.outlet_id,a.idrekan,a.idsales,a.jml_qty as jmlPesan,a.subtotal,a.disc_persen,a.tax_persen,a.pajak_biaya,a.biaya_lain,a.grand_total,a.dp,a.dp_so,a.kurang,b.nm_outlet,c.nmrekan,d.nmrekan as nmsales,a.created,a.created_by from tr_penjualan a inner join master_company b on a.outlet_id = b.outlet_id left join master_rekan_bisnis c on a.idrekan = c.idrekan left join master_rekan_bisnis d on a.idsales = d.idrekan $join where a.tgl >= '".$tgl1."' and a.tgl <= '".$tgl2."' and a.cancel = '0' $qr");
  ...
  <tr>
    ...
    <td bgcolor="<?php echo $bg; ?>"><div align="right"><?php echo $this->msistem->format_uang($rs->dp_so); ?></div></td>
  ...
  <tr>
    ...
    <td bgcolor="#FF9933"><div align="right"><?php echo $this->msistem->format_uang($J8); ?></div></td>
  </tr>
</table>
<p>&nbsp;</p>
</body>
