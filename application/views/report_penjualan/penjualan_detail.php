...
if($type=='EXCEL'):
	...
	header('Content-Disposition: attachment; filename=penjualan_detail'.$tgl1."_".$tgl2.".xls");	
endif;
?>
...
<table width="881" border="0" cellspacing="1">
  ...
  $sql = $this->db->query("select a.id,a.kdtrans,a.tgl,a.outlet_id,a.idrekan,a.idsales,a.jml_qty as jmlPesan,a.subtotal,a.disc_rp,a.tax_rp,a.pajak_biaya,a.biaya_lain,a.grand_total,a.dp,a.kurang,b.nm_outlet,c.nmrekan,d.nmrekan as nmsales,a.created,a.created_by from tr_penjualan a inner join master_company b on a.outlet_id = b.outlet_id left join master_rekan_bisnis c on a.idrekan = c.idrekan left join master_rekan_bisnis d on a.idsales = d.idrekan left join tr_penjualan e on a.kdtrans = e.kdpesanan $join where a.tgl >= '".$tgl1."' and a.tgl <= '".$tgl2."' and a.cancel = '0' $qr");
 ...
 /*  if($no%2==0) {
  ...
  <tr>
    ...
    <td bgcolor="<?php echo $bg; ?>"><strong><?php echo $rs->idrekan."-".$rs->nmrekan; ?></strong></td>
  ...
  <tr>
    <td colspan="5"><table width="874" border="0">
	  ...
	  $i = 1;
	  if($tmpUkuran == 1) {
	 	 $q = $this->db->query("select a.idbarang,concat(b.nmbarang,' ',b.nmwarna,' ',b.nmsize) as nmbarang,b.nmsatuan,a.qty,a.harga,a.disc_1,a.disc_2,a.disc_3,a.disc_4,a.total from tr_penjualan_detail a left join v_master_barang_detail b on a.idbarang = b.idbarang where a.kdtrans = '".$rs->kdtrans."'");
	  } else {
	   	 $q = $this->db->query("select b.idgroup_barang as idbarang,b.nmbarang,b.nmsatuan,sum(a.qty) as qty,a.harga,a.disc_1,a.disc_2,a.disc_3,a.disc_4,sum(a.total) as total from tr_penjualan_detail a left join v_master_barang_detail b on a.idbarang = b.idbarang where a.kdtrans = '".$rs->kdtrans."' group by b.idgroup_barang");
	  }
  ...
  <tr>
    ...
    <td><div align="right"><strong><?php echo $this->msistem->format_uang($J1); ?></strong></div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
