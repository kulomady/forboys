...
if($type=='EXCEL'):
	...
	header('Content-Disposition: attachment; filename=penjualan_item'.$tgl1."_".$tgl2.".xls");	
endif;
?>
...
<title>.: Laporan Penjualan Per-Item :.</title></head>
...
<table width="824" border="0" cellspacing="1">
  ...
  $sqlM = $this->db->query("select 
		...
		$nm as nmGrup
		from 
		tr_penjualan_detail a inner join tr_penjualan b on a.kdtrans = b.kdtrans
