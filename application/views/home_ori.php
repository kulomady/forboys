...
<!--<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/codebase_grid/ext/dhtmlxgrid_filter.js"> -->
<script  src="<?php echo base_url(); ?>assets/codebase_grid/ext/dhtmlxgrid_filter.js"></script>
<!-- <script  src="<?php echo base_url(); ?>assets/codebase_grid/ext/dhtmlxgrid_group.js"></script> -->
<script  src="<?php echo base_url(); ?>assets/codebase_grid/dhtmlxgridcell.js"></script>
<!-- <script  src="<?php echo base_url(); ?>assets/codebase_grid/ext/dhtmlxgrid_keymap_access.js"></script> -->
<!-- <script  src="<?php echo base_url(); ?>assets/codebase_grid/ext/dhtmlxgrid_markers.js"></script> -->
<!-- <script src="<?php echo base_url(); ?>assets/codebase_grid/ext/dhtmlxgrid_keymap_excel.js"></script> -->
<!-- Modal -->
...
<!-- other -->
<script src="<?php echo base_url(); ?>/assets/jquery-1.6.1.min.js"></script>
<script src="<?php echo base_url(); ?>/assets/jquery.price_format.js"></script>
...
<div id="my_logo" style="padding:0px; margin:0px;"><img src="<?php echo base_url(); ?>assets/img/header.png" /></div>
...
var win_brg = dhxWins.createWindow("win_brg",0,0,600,450);
...
gd_win_brg.setHeader("Kode #,Nama Barang,Warna,Ukuran,Satuan",null,["text-align:center","text-align:center","text-align:center"]);
gd_win_brg.setInitWidths("80,200,100,70,70");
gd_win_brg.setColAlign("left,left,left,left,left");
gd_win_brg.setColSorting("str,str,str,str,str");
gd_win_brg.setColTypes("ro,ro,ro,ro,ro");
...
function show_win_brg(idbarang) {
	...
	gd_win_brg.clearAll();
	gd_win_brg.loadXML(base_url+"index.php/master_barang/loadDataBarang/"+idbarang,function() {
...
function show_win_akun(kdtrans) {
...
function tandaPanahAkun(key) {
	if(key==13) {
		...
		if(kdtransAkun=='0') {
			...
			document.frm_ak4.txtno_akun.value = idperkiraan;
			 document.getElementById('tmpAkun_ak4').innerHTML = nmperkiraan;
		}
		win_akun.hide();
