...
function tampil_rsp8(type) {
	...
	if(document.frm_rsp8.gudangAsal.value == "") {
		gudangAsal = 0;
	} else {
		gudangAsal = document.frm_rsp8.gudangAsal.value;
	}
	...
	url = base_url+'index.php/report_stock/mutasi_stock_toko/'+tglStock+"/"+gudangAsal+"/"+tipe+"/"+jns+"/"+kat+"/"+merk+"/"+warna+"/"+tmpUkuran+"/"+type+"/"+jnsHrg+"/"+hpp;
