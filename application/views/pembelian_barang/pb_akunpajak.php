...
<table width="244" border="0">
  <tr>
    <td width="234" align="center">Kode Akun Pajak Pembelian</td>
  </tr>
  <tr>
...
cbAkun_pb1.loadXML(base_url+"index.php/master_perkiraan/cbPerkiraan",function() {
	IDcbAkun_pb1 = cbAkun_pb1.getIndexByValue('<?php echo $la_pajak_beli; ?>');
	cbAkun_pb1.selectOption(IDcbAkun_pb1,true,true);
});
cbAkun_pb1.attachEvent("onChange", function() {
	document.frm_pb1.akun_pajak.value = cbAkun_pb1.getSelectedValue();											
});
</script>