...
cbAkun_pb1.clearAll();
cbAkun_pb1.loadXML(base_url+"index.php/master_perkiraan/cbPerkiraanKasBank",function() {
	IDcbAkun_pb1 = cbAkun_pb1.getIndexByValue('<?php echo $la_uang_muka_beli; ?>');
	cbAkun_pb1.selectOption(IDcbAkun_pb1,true,true);
});
cbAkun_pb1.attachEvent("onChange", function() {
	document.frm_pb1.akun_dp.value = cbAkun_pb1.getSelectedValue();											
});
</script>