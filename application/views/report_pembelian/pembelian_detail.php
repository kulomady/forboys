...
<h2>LAPORAN PEMBELIAN DETAIL</h2>
...
trans_pembelian_brg_child.id,
trans_pembelian_brg_child.kdtrans,
trans_pembelian_brg_child.idbarang,
trans_pembelian_brg_child.qtyBeli,
trans_pembelian_brg_child.harga,
trans_pembelian_brg_child.disc,
trans_pembelian_brg_child.pajak,
trans_pembelian_brg_child.jumlah,
v_master_barang_detail.nmbarang,
v_master_barang_detail.nmsatuan
FROM
trans_pembelian_brg_child
INNER JOIN v_master_barang_detail ON trans_pembelian_brg_child.idbarang = v_master_barang_detail.idbarang
WHERE trans_pembelian_brg_child.kdtrans = '".$rs->kdtrans."'");
	$r = 1;
	$jml = 0;
	$num = $child->num_rows();
